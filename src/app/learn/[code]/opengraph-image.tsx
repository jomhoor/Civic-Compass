...
export default async function OGImage({
  ...
  try {
    ...
    if (res.ok) {
      ...
      // Replace ZWNJ (U+200C) with space — Satori's bidi algorithm reverses segments around ZWNJ
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#0EBB90" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">

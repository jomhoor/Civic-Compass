...
const en = {
  ...
  poke_back: "Poke Back",
  poke_btn: "Poke",
  poke_failed: "Failed to send poke. Please try again.",
  ...
  flashcard_link_copied: "Link copied!",
...
const fa: typeof en = {
  ...
  poke_btn: "سقلمه",
  poke_failed: "ارسال سقلمه ناموفق بود. لطفاً دوباره تلاش کنید.",
  ...
  flashcard_link_copied: "لینک کپی شد!",

...
export const questionsFa: Record<string, string> = {
  // ── Economy (1–10) ──
  "The government should provide universal healthcare, even if it means higher taxes.":
    "دولت باید بهداشت همگانی ارائه دهد، حتی اگر مالیات‌ها افزایش یابد.",
  "A flat tax rate for everyone is fairer than a progressive tax system.":
    "نرخ مالیات یکسان برای همه عادلانه‌تر از سیستم مالیات تصاعدی است.",
  "Public utilities like water and electricity should never be privatized.":
    "خدمات عمومی مانند آب و برق هرگز نباید خصوصی‌سازی شوند.",
  "Minimum wage laws do more harm than good by discouraging hiring.":
    "قوانین حداقل دستمزد با کاهش استخدام، بیشتر ضرر می‌زنند تا فایده.",
  "The state should own key industries such as energy and transportation.":
    "دولت باید صنایع کلیدی مانند انرژی و حمل‌ونقل را در اختیار داشته باشد.",
  "Free trade agreements benefit society more than protectionist tariffs.":
    "توافقنامه‌های تجارت آزاد بیش از تعرفه‌های حمایتی به جامعه سود می‌رسانند.",
  "Billionaires should not exist — extreme wealth should be taxed away.":
    "میلیاردرها نباید وجود داشته باشند — ثروت افراطی باید با مالیات حذف شود.",
  "Deregulating industries leads to more innovation and lower prices.":
    "مقررات‌زدایی از صنایع به نوآوری بیشتر و قیمت‌های پایین‌تر منجر می‌شود.",
  "Universal basic income is a better approach than traditional welfare programs.":
    "درآمد پایه همگانی رویکرد بهتری نسبت به برنامه‌های رفاهی سنتی است.",
  "Rent control is necessary to protect tenants in expensive cities.":
    "کنترل اجاره‌بها برای حمایت از مستاجران در شهرهای گران‌قیمت ضروری است.",
  ...
  "Power should be distributed to local communities rather than concentrated in a national government.":
    "قدرت باید بین جوامع محلی توزیع شود نه اینکه در دولت مرکزی متمرکز باشد.",
  "Term limits for all elected officials are essential to prevent corruption.":
    "محدودیت دوره برای همه مقامات منتخب برای جلوگیری از فساد ضروری است.",
  "Expert technocrats should make major policy decisions instead of elected politicians.":
    "تکنوکرات‌های متخصص باید تصمیمات سیاست‌گذاری بزرگ را بگیرند نه سیاستمداران منتخب.",
  "Citizens should be able to recall any elected official at any time through a referendum.":
    "شهروندان باید بتوانند هر مقام منتخبی را در هر زمان از طریق همه‌پرسی برکنار کنند.",
  "A political system with a single dominant party can provide more stability than multi-party democracy.":
    "یک سیستم سیاسی با حزب مسلط واحد می‌تواند ثبات بیشتری از دموکراسی چندحزبی فراهم کند.",
  "Juries of randomly selected citizens should have the power to veto laws.":
    "هیئت‌های منصفه‌ای از شهروندان تصادفی باید قدرت وتوی قوانین را داشته باشند.",
  ...
  "Freedom of speech should be absolute, with no exceptions for hate speech.":
    "آزادی بیان باید مطلق باشد، بدون هیچ استثنایی برای سخنان نفرت‌آمیز.",
  "Mass surveillance is acceptable if it prevents terrorist attacks.":
    "نظارت گسترده قابل‌قبول است اگر از حملات تروریستی جلوگیری کند.",
  "People should be allowed to own firearms for personal protection.":
    "مردم باید اجازه داشته باشند برای حفاظت شخصی سلاح گرم داشته باشند.",
  "Governments should be able to restrict internet content to protect public morality.":
    "دولت‌ها باید بتوانند محتوای اینترنتی را برای حفظ اخلاق عمومی محدود کنند.",
  "Peaceful protests should never be restricted, even if they disrupt daily life.":
    "اعتراضات مسالمت‌آمیز هرگز نباید محدود شوند، حتی اگر زندگی روزمره را مختل کنند.",
  "National ID systems and biometric databases improve public safety.":
    "سیستم‌های شناسایی ملی و پایگاه‌های داده بیومتریک امنیت عمومی را بهبود می‌بخشند.",
  "Whistleblowers who expose government wrongdoing should always be protected from prosecution.":
    "افشاگرانی که تخلفات دولتی را فاش می‌کنند باید همیشه از پیگرد قانونی محافظت شوند.",
  "Curfews and emergency powers are sometimes necessary to maintain public order.":
    "حکومت نظامی و اختیارات اضطراری گاهی برای حفظ نظم عمومی ضروری هستند.",
  "People have the right to use end-to-end encryption, even if it hampers criminal investigations.":
    "مردم حق استفاده از رمزنگاری سرتاسری را دارند، حتی اگر تحقیقات جنایی را دشوار کند.",
  "Mandatory military or civil service builds national unity and discipline.":
    "خدمت نظامی یا مدنی اجباری وحدت ملی و انضباط را تقویت می‌کند.",

  // ── Society (31–40) ──
  "Traditional family structures are the foundation of a stable society.":
    "ساختارهای سنتی خانواده پایه یک جامعه باثبات هستند.",
  "Marriage should be defined by individuals, not by religious or cultural traditions.":
    "ازدواج باید توسط افراد تعریف شود، نه توسط سنت‌های مذهبی یا فرهنگی.",
  "Schools should teach comprehensive sex education starting at an early age.":
    "مدارس باید آموزش جامع جنسی را از سنین پایین آغاز کنند.",
  "Immigration enriches our culture and should be encouraged.":
    "مهاجرت فرهنگ ما را غنی‌تر می‌کند و باید تشویق شود.",
  "Religious values should play a role in shaping public policy.":
    "ارزش‌های مذهبی باید در شکل‌دهی سیاست‌های عمومی نقش داشته باشند.",
  "Gender identity is a spectrum and should be legally recognized beyond male and female.":
    "هویت جنسیتی یک طیف است و باید فراتر از مرد و زن به رسمیت شناخته شود.",
  "A society that changes too quickly loses its cultural identity.":
    "جامعه‌ای که خیلی سریع تغییر کند هویت فرهنگی خود را از دست می‌دهد.",
  "Affirmative action programs are necessary to correct historical injustices.":
    "برنامه‌های اقدام مثبت برای اصلاح بی‌عدالتی‌های تاریخی ضروری هستند.",
  "Assimilation into the dominant culture should be expected of immigrants.":
    "از مهاجران باید انتظار همانندسازی با فرهنگ غالب رود.",
  "Art and media should challenge social norms, even if some people find it offensive.":
    "هنر و رسانه باید هنجارهای اجتماعی را به چالش بکشند، حتی اگر برخی آن را توهین‌آمیز بدانند.",

  // ── Diplomacy (41–50) ──
  "My country should prioritize its own interests over international cooperation.":
    "کشور من باید منافع خود را بر همکاری بین‌المللی اولویت دهد.",
  "Open borders would lead to greater global prosperity and understanding.":
    "مرزهای باز به رفاه و تفاهم جهانی بیشتر منجر می‌شود.",
  "International organizations like the UN do more good than harm.":
    "سازمان‌های بین‌المللی مانند سازمان ملل بیش از ضرر، منفعت دارند.",
  "Foreign aid is a waste of taxpayer money that should be spent domestically.":
    "کمک‌های خارجی اتلاف پول مالیات‌دهندگان است و باید در داخل خرج شود.",
  "Military alliances like NATO are essential for global stability.":
    "اتحادهای نظامی مانند ناتو برای ثبات جهانی ضروری هستند.",
  "Countries should have the absolute right to control their borders without outside interference.":
    "کشورها باید حق مطلق کنترل مرزهایشان را بدون دخالت خارجی داشته باشند.",
  "Global problems like climate change require global governance mechanisms.":
    "مشکلات جهانی مانند تغییرات اقلیمی به سازوکارهای حکمرانی جهانی نیاز دارند.",
  "Cultural exchange programs and student visas strengthen international bonds.":
    "برنامه‌های تبادل فرهنگی و ویزاهای دانشجویی پیوندهای بین‌المللی را تقویت می‌کنند.",
  "Economic sanctions are an effective and ethical tool of foreign policy.":
    "تحریم‌های اقتصادی ابزار مؤثر و اخلاقی سیاست خارجی هستند.",
  "A country's first duty is always to its own citizens, not to the global community.":
    "وظیفه اول یک کشور همیشه نسبت به شهروندانش است، نه جامعه جهانی.",

  // ── Environment (51–60) ──
  "Economic growth should never come at the cost of environmental protection.":
    "رشد اقتصادی هرگز نباید به بهای حفاظت از محیط زیست تمام شود.",
  "Nuclear energy is essential for achieving carbon neutrality.":
    "انرژی هسته‌ای برای دستیابی به خنثی‌سازی کربن ضروری است.",
  "Individual lifestyle changes matter less than systemic corporate regulation for the environment.":
    "تغییرات سبک زندگی فردی کمتر از مقررات سیستماتیک شرکتی برای محیط زیست اهمیت دارد.",
  "Developing countries should not be held to the same environmental standards as wealthy nations.":
    "کشورهای در حال توسعه نباید به همان استانداردهای زیست‌محیطی کشورهای ثروتمند پایبند باشند.",
  "We should ban single-use plastics entirely, even if it inconveniences consumers.":
    "باید پلاستیک‌های یک‌بار مصرف را کاملاً ممنوع کنیم، حتی اگر مصرف‌کنندگان را ناراحت کند.",
  "Climate change concerns are often exaggerated and hurt economic competitiveness.":
    "نگرانی‌های تغییرات اقلیمی اغلب اغراق‌آمیز هستند و رقابت‌پذیری اقتصادی را آسیب می‌زنند.",
  "Animal agriculture should be phased out for environmental and ethical reasons.":
    "دامداری صنعتی باید به دلایل زیست‌محیطی و اخلاقی به تدریج حذف شود.",
  "Resource extraction like mining and drilling is necessary for economic development.":
    "استخراج منابع مانند معدن‌کاوی و حفاری برای توسعه اقتصادی ضروری است.",
  "Cities should prioritize public transit and cycling over private car infrastructure.":
    "شهرها باید حمل‌ونقل عمومی و دوچرخه‌سواری را بر زیرساخت خودروهای شخصی اولویت دهند.",
  "Property owners should have the right to develop their land without environmental restrictions.":
    "مالکان ملک باید حق توسعه زمین خود را بدون محدودیت‌های زیست‌محیطی داشته باشند.",

  // ── Justice (61–70) ──
  "Rehabilitation should be the primary goal of the justice system, not punishment.":
    "بازپروری باید هدف اصلی سیستم قضایی باشد، نه مجازات.",
  "Some crimes are so severe that the death penalty is justified.":
    "برخی جنایات آنقدر شدید هستند که مجازات اعدام موجه است.",
  "Drug use should be treated as a public health issue, not a criminal one.":
    "مصرف مواد مخدر باید به عنوان یک مسئله بهداشت عمومی بررسی شود، نه جنایی.",
  "Harsher sentences are the best deterrent against crime.":
    "مجازات‌های سنگین‌تر بهترین بازدارنده جرم هستند.",
  "Restorative justice (mediation between victim and offender) should be used more widely.":
    "عدالت ترمیمی (میانجی‌گری بین قربانی و مجرم) باید بیشتر استفاده شود.",
  "Corporations that cause environmental damage should face criminal prosecution, not just fines.":
    "شرکت‌هایی که آسیب زیست‌محیطی می‌زنند باید با پیگرد جنایی روبرو شوند، نه فقط جریمه.",
  "Juvenile offenders should be tried as adults for violent crimes.":
    "مجرمان نوجوان باید برای جنایات خشونت‌آمیز مانند بزرگسالان محاکمه شوند.",
  "Prison labour is a form of exploitation that should be abolished.":
    "کار اجباری زندانیان نوعی بهره‌کشی است که باید لغو شود.",
  "Victims of crime should have more say in the sentencing process.":
    "قربانیان جرم باید نقش بیشتری در فرآیند صدور حکم داشته باشند.",
  "A society is best judged by how it treats its prisoners.":
    "بهترین معیار قضاوت یک جامعه نحوه رفتار با زندانیانش است.",

  // ── Technology (71–80) ──
  "Artificial intelligence should be regulated even if it slows down innovation.":
    "هوش مصنوعی باید تنظیم‌گری شود حتی اگر نوآوری را کُند کند.",
  "Social media companies should not be held liable for user-generated content.":
    "شرکت‌های رسانه‌های اجتماعی نباید مسئول محتوای تولیدشده توسط کاربران باشند.",
  "Governments should have the ability to shut down the internet during national emergencies.":
    "دولت‌ها باید توانایی قطع اینترنت را در شرایط اضطراری ملی داشته باشند.",
  "Genetic engineering of humans (gene therapy, designer babies) should be permitted.":
    "مهندسی ژنتیک انسان (ژن‌درمانی، نوزادان طراحی‌شده) باید مجاز باشد.",
  "Big tech monopolies need to be broken up, even if their products are popular.":
    "انحصارهای فناوری بزرگ باید شکسته شوند، حتی اگر محصولاتشان محبوب باشند.",
  "Cryptocurrency and decentralized finance will create a more equitable financial system.":
    "رمزارز و مالی غیرمتمرکز سیستم مالی عادلانه‌تری ایجاد خواهند کرد.",
  "Autonomous weapons (drones, AI soldiers) should be banned by international law.":
    "سلاح‌های خودمختار (پهپادها، سربازان هوش مصنوعی) باید توسط قوانین بین‌المللی ممنوع شوند.",
  "Open-source development produces better technology than proprietary corporate software.":
    "توسعه متن‌باز فناوری بهتری نسبت به نرم‌افزارهای انحصاری شرکتی تولید می‌کند.",
  "Data collected by tech companies should be treated as a public resource.":
